...
const scopedLintFiles = [
  ...
  'src/app/api/dropship/import/route.ts',
...
const steps: ReadinessStep[] = [
  ...
  {
    label: 'Public shop URL unit test',
    command: 'npm',
    args: ['run', 'test:public-shop-url'],
  },
  {
    label: 'Route smoke',
    command: 'npm',
