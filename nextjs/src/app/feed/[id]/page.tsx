...
const DEMO_ENTITY_DETAILS: FeedItemData[] = [
...

  {
    ...
    metadata: {
      ...
      roomChoiceDetails: [
        { label: '2 өрөө 58м²', rooms: 2, bedrooms: 1, bathrooms: 1, area: 58, availableUnits: 18, floorRange: '6-16 давхар', orientation: 'Урагшаа', balcony: 'Тагттай', finish: 'Цагаан засал', paymentTerms: ['Урьдчилгаа 30%', 'Банкны зээл'] },
        { label: '3 өрөө 92м²', rooms: 3, bedrooms: 2, bathrooms: 2, area: 92, availableUnits: 28, floorRange: '8-20 давхар', orientation: 'Уул руу', balcony: '2 тагттай', finish: 'Цагаан засал', paymentTerms: ['Урьдчилгаа 30%', 'Хувааж төлөх'] },
        { label: '4 өрөө 128м²', rooms: 4, bedrooms: 3, bathrooms: 2, area: 128, availableUnits: 14, floorRange: '12-22 давхар', orientation: 'Панорам', balcony: 'Том тагт', finish: 'Premium засал', paymentTerms: ['Банкны зээл', 'Төлбөрийн уян нөхцөл'] },
      ],
      highlights: ['Уулын үзэмж', 'Гэр бүлд тохиромжтой төлөвлөлт', 'Хаалттай хотхон'],
      nearby: ['Олон улсын сургууль 7 минут', 'Цэцэрлэг 5 минут', 'Супермаркет', 'Автобусны буудал 300м'],
      amenities: ['Хүүхдийн талбай', 'Фитнес', 'Хаалттай хотхон', 'Ногоон байгууламж'],
      documents: ['Төслийн зөвшөөрөл', 'Газрын гэрчилгээ', 'Барилгын ажлын явцын тайлан'],
      paymentTerms: ['Урьдчилгаа 30%', 'Банкны зээл', 'Хувааж төлөх нөхцөл'],
    },
  },
  { id: 'p2', refId: 'DEMO-COMPANY-002', title: 'Central Park Residence', description: 'Хотын төвийн ойролцоох premium residence төсөл. Ажлын байр, үйлчилгээ, сургууль цэцэрлэгтэй ойр.', price: 218400000, images: detailImages('mongolian-properties-central-park'), category: 'new_building', entityType: 'company', entityId: 'mongolian-properties', tier: 'featured', status: 'active', viewCount: 0, district: 'СБД', entityName: 'Монголиан Пропертиз', entityVerified: true, createdAt: '2026-04-02', metadata: { projectStatus: 'Барьж байна', address: 'СБД, 1-р хороо', totalUnits: 180, soldUnits: 81, availableUnits: 99, pricePerSqm: 5200000, completionDate: '2028', floors: 18, parking: 'Дулаан болон гадна зогсоол', ownerPhone: '7711-0000', roomChoices: ['1 өрөө 42м²', '2 өрөө 68м²', '3 өрөө 105м²'], roomChoiceDetails: [{ label: '1 өрөө 42м²', rooms: 1, bedrooms: 1, bathrooms: 1, area: 42, availableUnits: 21, floorRange: '5-18 давхар', orientation: 'Зүүн', balcony: 'Франц тагт', finish: 'Цагаан засал', paymentTerms: ['Урьдчилгаа 40%'] }, { label: '2 өрөө 68м²', rooms: 2, bedrooms: 1, bathrooms: 1, area: 68, availableUnits: 43, floorRange: '4-17 давхар', orientation: 'Баруун', balcony: 'Тагттай', finish: 'Цагаан засал', paymentTerms: ['Банкны зээл'] }, { label: '3 өрөө 105м²', rooms: 3, bedrooms: 2, bathrooms: 2, area: 105, availableUnits: 35, floorRange: '7-18 давхар', orientation: 'Урагшаа', balcony: '2 тагттай', finish: 'Premium засал', paymentTerms: ['Урьдчилгаа 40%', 'Банкны зээл'] }], highlights: ['Хотын төвд ойр', 'Premium lobby', 'Ажлын байртай ойр'], nearby: ['Оффисын бүс', 'Сургууль цэцэрлэг', 'Кофе шоп', 'Нийтийн тээвэр'], amenities: ['Консьерж', 'Камерын хяналт', 'Лобби'], documents: ['Барилгын зөвшөөрөл', 'Захиалгын гэрээний загвар', 'Төслийн танилцуулга'], paymentTerms: ['Урьдчилгаа 40%', 'Банкны зээл'] } },
  { id: 'p3', refId: 'DEMO-COMPANY-003', title: 'Green Valley', description: 'Ашиглалтад орсон ногоон хотхон. Шууд нүүж орох боломжтой үлдэгдэл цөөн байртай.', price: 198000000, images: detailImages('mongolian-properties-green-valley'), category: 'new_building', entityType: 'company', entityId: 'mongolian-properties', tier: 'featured', status: 'active', viewCount: 0, district: 'БГД', entityName: 'Монголиан Пропертиз', entityVerified: true, createdAt: '2026-04-02', metadata: { projectStatus: 'Ашиглалтад орсон', address: 'БГД, 3-р хороолол', totalUnits: 320, soldUnits: 316, availableUnits: 4, pricePerSqm: 3600000, completionDate: '2025', floors: 16, parking: 'Дулаан зогсоол', ownerPhone: '7711-0000', roomChoices: ['2 өрөө 55м²', '3 өрөө 88м²'], roomChoiceDetails: [{ label: '2 өрөө 55м²', rooms: 2, bedrooms: 1, bathrooms: 1, area: 55, availableUnits: 1, floorRange: '8-р давхар', orientation: 'Зүүн урагшаа', balcony: 'Тагттай', finish: 'Бүрэн засалтай', priceMnt: 198000000, moveInDate: 'Шууд нүүх боломжтой', paymentTerms: ['Ипотек', 'Шууд төлөлт'] }, { label: '3 өрөө 88м²', rooms: 3, bedrooms: 2, bathrooms: 2, area: 88, availableUnits: 3, floorRange: '6-14 давхар', orientation: 'Баруун урагшаа', balcony: '2 тагттай', finish: 'Бүрэн засалтай', priceMnt: 316800000, moveInDate: 'Шууд нүүх боломжтой', paymentTerms: ['Ипотек', 'Урьдчилгаа тохиролцоно'], notes: 'Гэр бүлд тохиромжтой, сургуулийн бүсэд ойр.' }], highlights: ['Шууд нүүх боломжтой', 'Үлдэгдэл цөөн', 'Гэр бүлд тохиромжтой'], nearby: ['Сургууль 4 минут', 'Цэцэрлэг 6 минут', 'Хүнсний дэлгүүр', 'Автобусны буудал 250м'], amenities: ['Сургууль ойр', 'Ногоон бүс', 'Хүүхдийн талбай'], documents: ['Үл хөдлөхийн гэрчилгээ бэлэн', 'Кадастрын зураг', 'СӨХ лавлагаа'], paymentTerms: ['Шууд төлөлт', 'Ипотек'] } },
  { id: 'p4', refId: 'DEMO-COMPANY-004', title: 'River Garden II', description: 'Төлөвлөлтийн шатанд буй River Garden II төсөл. Эрт захиалгын нөхцөлтэй.', price: 330000000, images: detailImages('mongolian-properties-river-garden'), category: 'new_building', entityType: 'company', entityId: 'mongolian-properties', tier: 'normal', status: 'active', viewCount: 0, district: 'СБД', entityName: 'Монголиан Пропертиз', entityVerified: true, createdAt: '2026-04-02', metadata: { projectStatus: 'Төлөвлөж байна', address: 'СБД, Туул голын эрэг', totalUnits: 150, soldUnits: 15, availableUnits: 135, pricePerSqm: 6000000, completionDate: '2029', floors: 20, parking: 'Төлөвлөсөн дулаан зогсоол', ownerPhone: '7711-0000', roomChoices: ['2 өрөө 55м²', '3 өрөө 88м²', 'Пентхаус 160м²'], roomChoiceDetails: [{ label: '2 өрөө 55м²', rooms: 2, bedrooms: 1, bathrooms: 1, area: 55, availableUnits: 48, floorRange: '3-15 давхар', orientation: 'Голын үзэмж', balcony: 'Тагттай', finish: 'Цагаан засал', paymentTerms: ['Захиалгын гэрээ', 'Хувааж төлөх'] }, { label: '3 өрөө 88м²', rooms: 3, bedrooms: 2, bathrooms: 2, area: 88, availableUnits: 64, floorRange: '5-18 давхар', orientation: 'Голын үзэмж', balcony: '2 тагттай', finish: 'Цагаан засал', paymentTerms: ['Захиалгын гэрээ', 'Банкны зээл'] }, { label: 'Пентхаус 160м²', rooms: 5, bedrooms: 4, bathrooms: 3, area: 160, availableUnits: 23, floorRange: '19-20 давхар', orientation: 'Панорам', balcony: 'Террастай', finish: 'Premium shell', paymentTerms: ['VIP захиалга', 'Хувааж төлөх'] }], highlights: ['Голын эрэг', 'Эрт захиалгын нөхцөл', 'Пентхаус сонголттой'], nearby: ['Туул голын эрэг', 'Алхалтын зам', 'Хотын төв рүү хурдан гарц'], amenities: ['Голын эрэг', 'Хаалттай хотхон'], documents: ['Захиалгын гэрээ', 'Төслийн концепц', 'Барилгын зөвшөөрөл боловсруулж байна'], paymentTerms: ['Захиалгын гэрээ', 'Хувааж төлөх'] } },
